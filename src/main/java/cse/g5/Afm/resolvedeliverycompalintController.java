...
public class resolvedeliverycompalintController {

    @FXML
    private Button assigncomplainttodepartmentbutton;
    ...
    @FXML
    void onmousebuttonclickassignandresolve(ActionEvent event) {

...
public class fueltipsController {

    @FXML
    private TextField entercustomername;

    @FXML
    private ComboBox<?> selectdeliverytypecombobox;

    @FXML
    private TextArea showfueltipstextarea;

    @FXML
    void onactionmousebuttonclicksendviaemail(ActionEvent event) {

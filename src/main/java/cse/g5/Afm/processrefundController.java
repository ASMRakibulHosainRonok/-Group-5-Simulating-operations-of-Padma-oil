...
public class processrefundController {
    ...
    @FXML
    private TextField enterorderidforsearch;

    @FXML
    private ComboBox<?> refunddecisioncombobox;

    @FXML
    private TextArea refundreasontextarea;

    @FXML
    void onactionmousebuttonclickapproverefund(ActionEvent event) {
    ...
    @FXML
    void onmousebuttonclickrejectrefund(ActionEvent event) {

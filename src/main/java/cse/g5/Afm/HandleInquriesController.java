...
public class HandleInquriesController {

    @FXML
    private TextField entercustomername;

    @FXML
    private Button inqueriessubmitbutton;
    ...
    @FXML
    private ComboBox<?> responsemethodchatbox;
    ...
    @FXML
    void onmousebutoonclicksubmitsolvedquery(ActionEvent event) {

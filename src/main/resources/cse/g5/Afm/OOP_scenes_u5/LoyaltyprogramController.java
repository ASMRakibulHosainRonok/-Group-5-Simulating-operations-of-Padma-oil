...
public class PleaseProvideControllerClassName {
    ...
    @FXML
    private TextArea customereligibilitystatusshow;

    @FXML
    private Button enrollcustomertoloyaltybutton;
    ...
    @FXML
    void onmousebuttonclickeligibility(ActionEvent event) {

    }

    @FXML
    void onmousebuttonclickenrollcustomertodatabase(ActionEvent event) {
